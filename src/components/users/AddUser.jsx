  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="md:col-span-1">
        <h3 className="text-lg font-medium leading-6 text-gray-900 dark:text-white">Add New User</h3>
        <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">Fill in the form below to add a new user.</p>
      </div>
